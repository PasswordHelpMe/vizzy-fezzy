...
class VizioTVController {
    constructor() {
        // Use environment variable if available, otherwise localStorage, otherwise default
        const envApiUrl = window.VIZIO_CONFIG?.DEFAULT_API_URL;
        this.apiUrl = localStorage.getItem('vizioApiUrl') || envApiUrl || 'http://localhost:8000';
